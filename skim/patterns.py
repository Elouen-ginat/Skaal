...
from skim.types import Consistency, Durability, Throughput
...
class EventLog(Generic[T]):
    ...
    def __init__(
        ...
        from skim.types import AccessPattern
    ...
    # ── Runtime API (stubs — implemented by skim-mesh in Phase 4) ──────────
...
class Saga:
    ...
    all named functions are registered before ``skim plan`` completes.
