"""PlanFile — the plan.skim.lock format: read, write, and diff."""
...
class PlanFile:
    ...
    def write(self, path: Path | None = None) -> Path:
        """Write the plan to plan.skim.lock (or a custom path)."""
    ...
    def read(cls, path: Path | None = None) -> "PlanFile":
        """Read and parse a plan.skim.lock file."""
