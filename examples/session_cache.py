...
@app.expose()
async def touch_session(session_id: str, extend_for: str = "45m") -> dict[str, Any]:
...
@app.expose()
async def issue_token(token_id: str, scope: str = "api") -> dict[str, Any]:
...
async def create_session_route(session_id: str, user_id: str = "demo-user") -> dict[str, Any]:
...
async def touch_session_route(session_id: str, extend_for: str = "45m") -> dict[str, Any]:
...
async def issue_token_route(token_id: str, scope: str = "api") -> dict[str, Any]:
